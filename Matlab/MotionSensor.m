    ...
    methods
        ...
        function [CPI] = GetCPI(obj)
            ...
            if (obj.sensorInit == 1 && obj.sensorReading == 0)
                ...
                params = fread(obj.serialPort,4,'int8');
                CPI = params([1 2]);
            end
        end
        ...
        function SetParams(obj,params)
            ...
            % params[2] = sensor 2 CPI
            % params[3] = sensor 1 LD
            % params[4] = sensor 2 LD
            if (length(params) ~=4)
                display('Params should have length 4')
                return;
            end
            if (obj.sensorInit == 1 && obj.sensorReading == 0)
                params = [4 params];
